...
Public Class DraftGenerationService
    ...
    Public Function GenerateForAssembly(seApplication As SolidEdgeFramework.Application,
        ...
        Return GenerateForFiles(seApplication, assembly.Path, options, targetFiles, progress, shouldCancel)
    End Function

    Public Function GenerateForFiles(seApplication As SolidEdgeFramework.Application,
